...
function Gallery({ isActive }) {
  ...
  const photos = [
    ...
    { src: "/images/7.png", alt: "Memory 7", caption: "Special memories", size: "small" },
    { src: "/images/8.png", alt: "Memory 8", caption: "Wonderful moments", size: "medium" },
    { src: "/images/9.png", alt: "Memory 9", caption: "Joyful times", size: "large" },
